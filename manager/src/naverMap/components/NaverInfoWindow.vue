...
import { onUnmounted, toRefs, ref, watch  ,defineEmits} from "vue";
import { mapInstance } from "@/naverMap/stores";
import { useLoad } from "@/naverMap/composables/useLoad";
import { addEventInfoWindow } from "@/naverMap/composables/useEvent";
import { UI_EVENT_INFOWINDOW } from "@/naverMap/constants/events";
import {
  ERROR_NONE_INFOWINDOW,
  ERROR_MAP_IS_NOT_DEFINED,
} from "@/naverMap/constants/errors";
