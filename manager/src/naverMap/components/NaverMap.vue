...
import { onMounted, onUnmounted, ref, useAttrs, toRefs ,defineEmits } from "vue";
import { mapInstance, mapCallbackList, mapIsLoaded } from "@/naverMap/stores";
import { addEventMap } from "@/naverMap/composables/useEvent";
import { useSetupScript } from "@/naverMap/composables/useSetup";
import { LAYER_TABLE } from "@/naverMap/constants/tables";
import { UI_EVENT_MAP } from "@/naverMap/constants/events";
