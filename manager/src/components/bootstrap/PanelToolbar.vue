...
<template>
	<div class="panel-heading-btn">
		...
		<a href="javascript:;" class="btn btn-xs btn-icon btn-success" ref="reloadToggler" v-show="false"><i class="fa fa-redo"></i></a>
		<a href="javascript:;" class="btn btn-xs btn-icon btn-warning" ref="collapseToggler" v-show="false"><i class="fa fa-minus"></i></a>
		<a href="javascript:;" class="btn btn-xs btn-icon btn-danger" ref="removeToggler" v-show="false"><i class="fa fa-times"></i></a>
	</div>
</template>
