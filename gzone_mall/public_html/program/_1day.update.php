...
switch($siteInfo['s_pg_type']){
	...
	case "inicis" :
		...
		include_once(OD_PROGRAM_ROOT.'/check.pg.inicis_api.php');
		// LCY : 2022-12-28 : 이니시스TX모듈 교체 -- 결제수단 추가 }
		break;
}
...
// 티켓만료처리 -- 사용이 대기이고 유효기간이 지난 티켓을 만료처리한다. 
update_order_ticket_expiration();


// 타임세일 끝났을 경우 숨김처리 -- 타임 세일 기간이 끝난경우 상품 숨김처리
// update_time_sale_view(); // LCY : 2023-10-25 : 타임세일패치 -- 타임세일 숨기지 않는다.

// LCY : 2023-04-10  : 휴면처리 30일전 알림
include_once OD_PROGRAM_ROOT."/check.sleep_ready.automail.php";