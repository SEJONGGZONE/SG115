...
$p_option1_title = $r['p_option1_title']?$r['p_option1_title'].' : ':'';
$p_option2_title = $r['p_option2_title']?$r['p_option2_title'].' : ':'';
$p_option3_title = $r['p_option3_title']?$r['p_option3_title'].' : ':'';
...
if($r[p_option_type_chk] == "3depth") {
	...
	foreach( $pores as $k=>$por ){
		$arr_option_data[$por[po_uid]]['option_name1'] = $p_option1_title.$por[po1_poptionname];
		$arr_option_data[$por[po_uid]]['option_name2'] = $p_option2_title.$por[po2_poptionname];
		$arr_option_data[$por[po_uid]]['option_name3'] = $p_option3_title.$por[po_poptionname];
	...
	foreach( $pores as $k=>$por ){
		$arr_option_data[$por[po_uid]]['option_name1'] = $p_option1_title.$por[po1_poptionname];
		$arr_option_data[$por[po_uid]]['option_name2'] = $p_option2_title.$por[po_poptionname];
		$arr_option_data[$por[po_uid]]['option_supplyprice'] = $por[po_poption_supplyprice];
		$arr_option_data[$por[po_uid]]['option_price'] = $por[po_poptionprice];
		$arr_option_data[$por[po_uid]]['option_cnt'] = $por[po_cnt];
	}
	...
	$pores = _MQ_assoc($poque);
	foreach( $pores as $k=>$por ){
		$arr_option_data[$por[po_uid]]['option_name1'] = $p_option1_title.$por[po_poptionname];
		$arr_option_data[$por[po_uid]]['option_supplyprice'] = $por[po_poption_supplyprice];
		$arr_option_data[$por[po_uid]]['option_price'] = $por[po_poptionprice];
		$arr_option_data[$por[po_uid]]['option_cnt'] = $por[po_cnt];
	}
