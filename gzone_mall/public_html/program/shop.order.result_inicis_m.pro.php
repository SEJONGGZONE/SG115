 ...
 {   
	...
	/*
	   echo("승인결과코드:".$inimx->m_resultCode."<br>");
		...
		$depositor = $inimx->m_buyerName != '' ? $inimx->m_buyerName : $r['o_oname'];
		...
		$bank_owner = $inimx->m_nmvacct;
			_MQ_noreturn("
				...
				'$ordernum', '$indr[in_id]', now(), '$tno', '$ool_type', '$app_time', '$amount', '$amount', '$account', '', '".$depositor."', '$ool_bank_name_array[$bankcode]', '$bankcode', '$escw_yn', '', '$buyr_tel2', '$bank_owner'
				)
			");
