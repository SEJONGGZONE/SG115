...
if($app_cnt < 1) {
	...
	if( $ptor[cnt] ) {	 // 이미 입력된 값이면 수정
		...
		$sque = "insert into smart_product_tmpoption set 
						...
						pto_pcode='" . $code . "',
						pto_cnt='".$app_cnt."',
						pto_poptionname1 ='".addslashes($arr_option_data[$pto_pouid]['option_name1'])."',
						pto_poptionname2 ='".addslashes($arr_option_data[$pto_pouid]['option_name2'])."',
						pto_poptionname3 ='".addslashes($arr_option_data[$pto_pouid]['option_name3'])."',
