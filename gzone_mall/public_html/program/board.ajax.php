...
switch( $ajaxMode ){
	...
	case "execAddfile":
		...
		$nextIdx = ($idx+1);
		$html = '	<div class="duplicate list-files" data-mode="add">';
		$html .= '	<div class="input_file_box">';
		$html .= '		<input type="text" id="fakeFileTxt'.$nextIdx.'" class="fakeFileTxt" readonly="readonly" disabled="" placeholder="파일 등록">';
		...
		$html .= '		</div>';
		$html .= '	</div>';
		$html .= '	<span class="add_btn_box"><a href="#none" onclick="return false;" class="file_btn exec-delfile">- 삭제</a></span>';
		$html .= '	</div>';
