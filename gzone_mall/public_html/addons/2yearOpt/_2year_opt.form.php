		...
		<table class="table_form">
			...
			<tbody>
				...
				<tr class="tr-2year-opt-use" style="display: none;">
					...
					<td>
						<div class="lineup-row">
							<a href="#none" class="c_btn h27 blue js_pg_popup" data-mode="2yearSend" data-width="800" data-height="400" data-page="_addons.popup.php">이메일 발송하기</a>
				...
				<tr class="tr-2year-opt-use" style="display: none;">
					<th class="">발송메일 설정</th>
					<td>
						<a href="#none" class="c_btn h27 blue line js_pg_popup" data-mode="2yearMail" data-width="1200" data-height="800" data-page="_addons.popup.php">이메일 설정하기</a>
				...
				<tr>
					...
					<td>
						<div class="tip_box">
							<?=_DescStr("정보통신망법 제50조제8항 및 동법 시행령 제62조의3은 최초 동의한 날로부터 매2년마다 하도록 규정하고 있습니다.")?>
							<?=_DescStr("이에 따라 수신동의 받은 날부터 매 2년 마다 수신동의 여부를 재확인 해야 합니다.")?>
