...
//	}
	...
	switch( $mode ){
		...
		// 현금영수증 임시저장
		case "save" :
			// LCY : 2023-10-06 : 현금영수증 메소드 업데이트 
			// include( dirname(__FILE__)."/api_cashbill/_cash.RegistCashBill.php");
			include( dirname(__FILE__)."/api_cashbill/_cash.RegistCashBillEx.php");
		break;
		...
		case "chk_cashbill" :
			...
			include( dirname(__FILE__)."/api_cashbill/_cash.GetCashBillEx.php");
		break;
		...
		case "update" :
			...
			include( dirname(__FILE__)."/api_cashbill/_cash.UpdateCashBillEx.php");
		break;
