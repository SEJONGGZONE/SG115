...
//<!-- <p>UpdateCashBillEx - 수정</p> -->
	$CashBill = array(
		...
		// 'TradeDeductionType' => '', // 2023-10-06 : 신규추가 => 추가공제 : (Y : 대중교통 , C : 도서/공연비)
	...
	$Result = $BaroService_CASHBILL->UpdateCashBillEx(array(
		'CERTKEY'	=> $CERTKEY,
		'CorpNum'	=> $CashBill['FranchiseCorpNum'],
		'UserID'	=> $CashBill['FranchiseMemberID'],
		'Invoice'	=> $CashBill
	))->UpdateCashBillExResult;
