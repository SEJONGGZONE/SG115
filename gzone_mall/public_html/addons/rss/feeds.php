...
<?php
	...
	function rss_get_category_name($cuid)
	{
		...
		$cate_name =  _MQ("select c_name from smart_category where c_uid = '". rm_str($cuid) ."' and c_depth=1 ");
	...
	function rss_create($cuid)
	{
		...
		$content .="<generator>".$siteInfo['s_adshop']."</generator>"; // LCY : 2023-10-18 : 입점업체 업데이트
