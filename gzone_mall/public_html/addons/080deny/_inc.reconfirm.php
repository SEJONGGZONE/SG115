...
<div class="popup sms_chk_again_page" style="width:1000px; background-color: #fafafa; display: none;">
	...
	<div class="pop_title">
		<strong>SMS 수신여부 재확인</strong>
		<a href="#none" onclick="return false;" title="닫기" class="btn_close close"></a>
	</div>
				...
				<table class="table_form">
					...
					<tbody>
						<tr>
							<th>알림</th>
							<td>
								발송대상자 중 수신거부 회원이 <span class="t_bold t_blue">[<strong class="_deny_cnt"></strong>명]</span> 포함되어있습니다. <br>
						...
						<tr>
							...
							<td>
								<div class="tip_box">
									<div class="c_tip ">발송되는 내용에 광고성, 또는 이벤트성 문구가 삽입되어있는지 확인해 주세요.(새해인사/생일축하/기념일/축하문자/안부인사 등등)</div>
									<div class="c_tip ">주문관련 발송이라 하더라도 발송내용에는 광고성 또는 이벤트성 문구가 삽입되어선 안됩니다.</div>
									<div class="c_tip ">야간의 경우 21시 부터 다음날 8시 전까지 는 별도의 고객 수신동의 가 있어야 합니다.</div>
								</div>
							</td>
						</tr>
						<tr>
	...
	<div class="c_btnbox type_full _type_deny">
		<ul>
			<li><a href="#none" onclick="sms_chk_send('deny'); return false;" class="c_btn h34 red line">제외하고 발송</a></li>
			<li><a href="#none" onclick="sms_chk_send('allow'); return false;" class="c_btn h34 red">포함하여 발송</a></li>
		</ul>
	</div>


	<div class="c_btnbox type_full _type_allow">
		<ul>
			<li><a href="#none" onclick="sms_chk_send('allow'); return false;" class="c_btn h34 red">발송하기</a></li>
		</ul>
	</div>
