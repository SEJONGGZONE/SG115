			...
			<tbody>
				<tr>
					...
					<td>
						...
						<div class="tip_box">
						<?php echo _DescStr("광고성 이메일은 수신동의를 한 회원에게만 발송이되며, 수신동의, 거부와 관련된 문구를 반드시 명시하셔야 하며, 수신거부 기능 또한 반드시 추가해야합니다.")?>
						<?php echo _DescStr("수신동의 문구는 반드시 텍스트와 치환자로만 작성해 주셔야합니다.")?>
						<?php echo _DescStr("수신동의/거부에 대한 문구를 기본설정으로 되돌릴 시 <a href='#none' onclick='set_default()'>이곳</a> 을 클릭해 주세요.")?>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="tip_box">
						<?php echo _DescStr("<strong>[__deny__]</strong> 수신거부 에대한 기능 링크를 자동으로 생성해 줍니다.")?>
						</div>
					</td>
				</tr>
