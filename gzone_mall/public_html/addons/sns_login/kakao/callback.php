...
// KAY : 2023-11-06 :: SNS 로그인 수정
$print_name = $SNSLoginData['kakao_account']['name']!=''?$SNSLoginData['kakao_account']['name']:$SNSLoginData['properties']['nickname'];

// 카카오는 전화번호 형식이 +82 000-0000-0000 으로 들어옴
$print_tel ='';
if($SNSLoginData['kakao_account']['phone_number']!=''){
	$ex_print_tel = explode(' ',$SNSLoginData['kakao_account']['phone_number']);
	$print_tel = tel_format(rm_str($ex_print_tel[1]));
}
