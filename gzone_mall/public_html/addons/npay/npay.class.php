					...
					foreach($po[$k] as $kk=>$vv) {
						...
						_MQ_noreturn("
							insert smart_npay set
								  c_pcode 				= '". $k ."'
								, c_option1				= '". addslashes($vv['pto_poptionname1'])."'
								, c_option2				= '". addslashes($vv['pto_poptionname2'])."'
								, c_option3				= '". addslashes($vv['pto_poptionname3'])."'
								, c_cnt					= '".$vv['pto_cnt']."'
			...
			foreach($po as $k=>$v) {
				foreach($v as $kk=>$vv) {
					...
					_MQ_noreturn("
						insert smart_npay set
							  c_pcode 				= '". $vv['c_pcode'] ."'
							, c_option1				= '". addslashes($vv['c_option1'])."'
							, c_option2				= '". addslashes($vv['c_option2'])."'
							, c_option3				= '". addslashes($vv['c_option3'])."'
							, c_cnt					= '".$vv['c_cnt']."'
							, c_pouid				= '".$vv['c_pouid']."'
							, c_cookie				= '".$this->User."'
							, c_rdate				= now()
