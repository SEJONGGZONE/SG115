...
# 필수 라이브러리 검증
if(!function_exists('mcrypt_encrypt')) { echo '서버관리자에게 mcrypt 2.6.8, libmcrypt 2.5.8 설치를 요청 하세요.'; phpinfo(); exit; }
if(!function_exists('mhash')) { echo '서버관리자에게 mhash 0.9.9.9 설치를 요청 하세요.'; phpinfo(); exit; }
?>
<!DOCTYPE html>
<html>
	<head>
