...
$arr_payment_type['easypay_naverpay'] = '네이버페이';
$arr_paymethod_name['EN'] = '네이버페이';
$arr_available_easypay_pg_list = array('easypay_naverpay'=>$arr_payment_type['easypay_naverpay'],'easypay_kakaopay'=>$arr_payment_type['easypay_kakaopay']); // 기본 제공
...
// LCY : 2023-01-04 : 자동정산대기처리 가능한 결제수단 따로 정의  (PG간편결제는 카드로 들어가므로 제외)
$arr_settlement_paymethod_name = $arr_paymethod_name;
unset($arr_settlement_paymethod_name['EK'],$arr_settlement_paymethod_name['EN']); // 네이버,카카오
...
$arr_order_payment_type = array("card" , "iche" , "hpp" , "point" , "payco" , "payple"); // 주문목록 노출 시 결제완료시에만 노출되는 결제수단
// {{{PG취소가능 결제수단}}} // SSJ : 주문/결제 통합 패치 : 2021-02-24
// JJC : 간편결제 - 페이플 : 2021-06-05 -- 페이플 결제수단 추가 --

// - 주문상태 ---
$arr_order_status = array('결제대기' , '결제완료' , '배송준비' , '배송중' , '배송완료' , '발급완료', '주문취소');
// - 주문상태 ---

// - 진행중인 주문 상태 ---
$arr_order_status_ordering = array('결제대기' , '결제완료' , '배송대기' , '배송준비' , '배송중' );
// - 진행중인 주문 상태 ---

// - 주문 컴플레인 상태 ---
// 교환/반품 신청, 교환/반품 완료, PG연동, 적립금 환불
//$arr_order_complain = array('교환/반품 신청' , '교환/반품 완료' , 'PG연동' , '적립금 환불' );
$arr_order_complain = array('교환/반품신청'=>'교환/반품 신청' , '교환/반품완료'=>'교환/반품 완료' , '완료/부분취소요청(PG연동)'=>'PG연동' , '완료/부분취소요청(적립금 환불)'=>'적립금 환불' );
$arr_order_subadmin_complain = array('교환/반품신청'=>'교환/반품신청' , '교환/반품완료'=>'교환/반품 완료'  ); // 입점관리자 전용
...
// - 정산을 위한 주문상품 배송상태 ---
$arr_order_product_sendstatus = array('배송대기','배송준비','배송중','배송완료');// 상품배송상태
$arr_order_product_settlestatus = array('자격미달','신청가능','신청완료','지급완료');// 상품정산상태
$arr_order_settlement_status = array("none"=>"정산미정","ready"=>"정산대기","complete"=>"정산완료");
// - 정산을 위한 주문상품 배송상태 ---
...
$arr_sms_text_type = array(
	...
	"order_pay"		=>"결제완료시",
	"delivery"		=>"상품배송시",
	"ticket"		=>"티켓발급시", // LCY : 2023-01-05 : 티켓 -- SMS추가
	"ticket_use"		=>"티켓사용완료", // LCY : 2023-01-05 : 티켓 -- SMS추가
	"ticket_unuse"		=>"티켓사용취소", // LCY : 2023-01-05 : 티켓 -- SMS추가
	"order_cancel"  =>"주문취소시",
...
$arr_pg_type = array(
	...
	//"allthegate"	=>"올더게이트",
	"lgpay"			=>"토스페이먼츠",
//	"billgate"		=>"빌게이트",  // LCY : 2021-01-22 : 빌게이트 사용안함
	"daupay"		=>"키움페이"
);
...
$arr_delivery_company = array(
	...
	,"농협택배"=>"https://ex.nhlogis.co.kr/dlvy/dlvy/view.do?invNo="
...
$arr_o_status = array(
"결제대기" => "<span class='c_tag gray h22 line t4'>결제대기</span>",
"결제완료" => "<span class='c_tag blue h22 line t4'>결제완료</span>",
"배송중" => "<span class='c_tag green h22 line t4'>배송중</span>",
"배송완료" => "<span class='c_tag darkgreen line h22 t4'>배송완료</span>",
"주문취소" => "<span class='c_tag h22 light t4'>주문취소</span>",
"결제실패" => "<span class='c_tag h22 red line t4'>결제실패</span>",
);

$arr_o_status_new = array(
	"결제대기" => "<span class='icon_state state_ready'>결제대기</span>",
	"결제완료" => "<span class='icon_state state_pay'>결제완료</span>",
...
"결제완료" => "<span class='state state_pay'>결제완료</span>",
...
"전액적립금" => "<span class='c_tag purple h22 t5'>적립금결제</span>",
...
"결제대기" => "<span class='c_tag gray h22 t4'>결제대기</span>",
"결제완료" => "<span class='c_tag blue h22 t4'>결제완료</span>",
"결제확인" => "<span class='c_tag violet h22 t4'>결제확인</span>",
"환불요청" => "<span class='c_tag aqua h22 t4'>환불요청</span>",

"현금영수증 요청" => "<span class='c_tag light h22 t6'>현금영수증 요청</span>",
"현금영수증 발행" => "<span class='c_tag sky line t6'>현금영수증 발행</span>",

"배송대기" => "<span class='c_tag ygreen line h22 t4'>배송대기</span>",
...
"주문취소" => "<span class='c_tag light h22 t4'>주문취소</span>",
"결제실패" => "<span class='c_tag red h22 t4'>결제실패</span>",
"발급완료" => "<span class='c_tag purple h22 t4'>발급완료</span>",


"노출" => "<span class='c_tag h18 blue line t3'>노출</span>",
"숨김" => "<span class='c_tag h18 light t3'>숨김</span>",
"비노출" => "<span class='c_tag h18 gray t3'>비노출</span>", // KAY :: 에디터 이미지 : 2021-07-20 :: 에디터 이미지 비노출 아이콘 추가
...
"적립완료" => "<span class='c_tag h18 blue line'>적립완료</span>",
"적립예정" => "<span class='c_tag h18 blue '>적립예정</span>",
"적립취소" => "<span class='c_tag h18 light'>적립취소</span>",

"사용" => "<span class='c_tag h18 blue line t3'>사용</span>",
"중지" => "<span class='c_tag h18 light t3'>중지</span>",
"미사용" => "<span class='c_tag h18 light t3'>미사용</span>",
"사용대기" => "<span class='shop_state_pack'><span class='sky'>사용대기</span></span>",

"공지" => "<span class='c_tag h18 yellow'>공지</span>",

// LCY : 2022-12-21 : 티켓기능 -- 상품타입 아이콘 추가 {
"delivery" => "<span class='c_tag darkgreen line t4'>배송상품</span>",
"ticket" => "<span class='c_tag purple line t4'>티켓상품</span>",
// LCY : 2022-12-21 : 티켓기능 -- 상품타입 아이콘 추가 }

// LCY : 2022-12-21 : 티켓기능 -- 상품설정 아이콘 추가 {
"dateoption" => "<span class='c_tag h18 red'>달력옵션</span>",
// LCY : 2022-12-21 : 티켓기능 -- 상품설정 아이콘 추가 }
...
$arr_reqinfo_ticket_keys = array("티켓 사용처","취소/환불");

// 상품타일별 이름
$arr_product_type_name = array('delivery'=>'배송상품','ticket'=>'티켓상품');
...
$NPayCourier = array(
	...
	'EPOST'=>'http://service.epost.go.kr/trace.RetrieveRegiPrclDelivTibco.postal?sid1=', // 우체국택배
...
$arrProGuideType = array('10'=>'구매/배송','20'=>'교환/반품/환불 가능','30'=>'교환/반품/환불 불가능');
...
$arrDisplayPinfo1 = array(
	'screenPrice' => '정상가(이전가격)'
	,'point' => '적립금'
	,'coupon' => '상품쿠폰'
	,'indrbenefits'=>'회원혜택'
);

$arrDisplayPinfo2 = array(
	'brand' => '브랜드'
	,'maker'=>'제조사'
	,'orgin' => '원산지'
	,'deliveryInfo' => '배송정보'
...
$arr_order_discount_field = array(
	'o_price_coupon_individual' => '주문쿠폰',
...
$arr_order_area_basic_etc = array('강원', '경기', '경남' , '경북' , '광주' , '대구' , '대전' , '부산' , '서울' , '세종' , '울산' , '인천' , '전남' , '전북' , '제주' , '충남' , '충북','티켓');
...
// -- LCY :: 게시판 노출 유형
$arrBoardViewType = array('service'=>'<span class="c_tag purple">고객센터</span>','community'=>'<span class="c_tag green">커뮤니티</span>');
...
$arrUpfileConfig['ext'] = array('file'=>array('zip','xls','xlsx' , 'pdf' , 'ppt', 'pptx' , 'doc' , 'docx', 'hwp'), 'images'=>array('jpg','jpeg','png','gif'),'all'=>array('zip','xls','xlsx' , 'pdf' , 'ppt', 'pptx' , 'doc' , 'docx', 'hwp','jpg','jpeg','png','gif') );
...
// 캐싱을 위한 캐시버전 생성
$cache_ver = date('Ymd', time()).(isset($_none_cache)?str_replace(array('0.', ' '), array('.', ''), microtime()):0);
...
// KAY :: 2022-08-03 :: MD'S PICK 추가/수정/삭제 가능하도록 수정
$varMdAuth = true;
...
$arrCouponSet = array(
	...
	"ocs_type_view"=>array("order"=>"<span class='c_tag purple'>주문쿠폰</span>","delivery"=>"<span class='c_tag brown'>배송쿠폰</span>"), // 쿠폰유형 => product: 상품적용, order : 주문적용, delivery :: 배송할인
	"ocs_issued_type"=>array("manual"=>"수동발급","auto"=>"자동발급"), // 발급방식 => manual : 수동발급, auto : 자동발급, download : 다운로드
	"ocs_issued_type_auto"=>array("1"=>"첫 구매/결제완료","2"=>"구매/결제완료","3"=>"생일축하","4"=>"회원가입","5"=>"출석체크"),  // 자동발급 설정
	...
	"ocs_issued_due_type"=>array("Y"=>"중복발급 적용","N"=>"중복발급 미적용"), // 같은 유형의 쿠폰과 중복사용 여부
);
$arr_coupon_type = array("order"=>"주문쿠폰","delivery"=>"배송쿠폰");


// 2020-04-16 SSJ :: 하이브리드 앱 - 앱설치쿠폰 추가
$arrCouponSetApp = array("6"=>"앱 설치");
foreach($arrCouponSetApp as $k=>$v) $arrCouponSet['ocs_issued_type_auto'][$k] = $v;
...
$arrProductDisplyImage = array(
	...
	'mobile'=>array(3=> 'type_3x1.gif', 2=> 'type_2x1.gif', 1=> 'type_m1x1s2.gif',0=> 'type_m1x1.gif')
);

$arrProductDisplyImage2 = array('thumb'=>'type_m1x1s2.gif','list'=>'type_list1x.gif');
...
//KAY :: 2022-08-25 :: 혜택구분
$arrSearchBeType = array('무료배송','조건부 무료배송', '할인 상품', '쿠폰 상품', '적립금 지급');

//KAY :: 2022-08-26 :: 목록컨트롤러 (정렬)
$arrOrderFilter = array(
	''=>'추천순'
	,'sale'=>'인기순'
	,'date'=>'최신순'
	,'price_desc'=>'높은 가격순'
...
// LCY : 2022-12-21 : 티켓기능 -- 요일 신규등록
$arr_date_var = array(
	'date_week'=>array("일","월","화","수","목","금","토"),
	'date_week2'=>array("일요일","월요일","화요일","수요일","목요일","금요일","토요일"),
);
$arr_day_week_normal = array(1=>'월요일',2=>'화요일',3=>'수요일',4=>'목요일',5=>'금요일',6=>'토요일',0=>'일요일',);
$arr_day_week_short = array(1=>'월',2=>'화',3=>'수',4=>'목',5=>'금',6=>'토',0=>'일');
$arr_day_week_short2 = array(1=>'월',2=>'화',3=>'수',4=>'목',5=>'금',6=>'토',7=>'일');
$arr_day_week_day = array('월'=>2,'화'=>3,'수'=>4,'목'=>5,'금'=>6,'토'=>7,'일'=>1);


// LCY : 2023-01-03 : 상품 자동아이콘 전역변수 배열화
$arr_product_icon_type_auto = array('product_coupon_small_icon'=>'상품 할인쿠폰', 'product_freedelivery_small_icon'=>'무료배송 상품', 'product_promotion_small_icon'=>'기획전 적용상품','product_ticket_small_icon'=>'티켓상품');

// 상품 아이콘 유형
$arr_product_icon_type = array(
	'product_name_small_icon' => "선택적용",
);


// 티켓의 사용상태
$arr_ticket_status = array('대기'=>'미사용','사용'=>'사용완료','만료'=>'만료','취소'=>'취소'); // 사용상태 표시값,
$arr_ticket_status_icon = array('대기'=>'<span class="c_tag h18 gray t3">미사용</span>','사용'=>'<span class="c_tag h18 blue line t3">사용완료</span>','만료'=>'<span class="c_tag h18 gray t3"><span class="sky">만료</span></span>','취소'=>'<span class="c_tag h18 gray t3">취소</span>'); // 사용상태 표시값,


// 금일 기준 날짜를 저장한다.
$arrTodayToDate = array(
	'today'=> array('name'=>'오늘', 'sdate'=>date('Y-m-d'), 'edate'=>date('Y-m-d') ),
	'1week'=> array('name'=>'1주일', 'sdate'=>date('Y-m-d',strtotime('-1week')), 'edate'=>date('Y-m-d') ),
	'1month'=> array('name'=>'1개월', 'sdate'=>date('Y-m-d',strtotime('-1month')), 'edate'=>date('Y-m-d') ),
	'3month'=> array('name'=>'3개월', 'sdate'=>date('Y-m-d',strtotime('-3month')), 'edate'=>date('Y-m-d') ),
	'6month'=> array('name'=>'6개월', 'sdate'=>date('Y-m-d',strtotime('-6month')), 'edate'=>date('Y-m-d') ),
	'1year'=> array('name'=>'1년', 'sdate'=>date('Y-m-d', strtotime('-1years')), 'edate'=>date('Y-m-d') ),
);


// KAY : 2023-04-10 : 신고하기 기능 추가 -- 신고하기 타입을 지정
$arr_reposrt_reason = array(
	'review'=> array(1=>'상품과 관련없는 내용',2=>'개인정보 누출 위험',3=>'저작권 불법 도용(타인이 작성한 글, 사진 등)',4=>'기타')
); 

// LCY : 2023-05-31 : 입점업체 SMS추가 -- 허용가능 문자 타입
$arr_sms_text_com_allow_type = array('order_pay','delivery','ticket','ticket_use','ticket_unuse','order_cancel','cancel_part_request','order_cancel_part','product_review','product_talk',);