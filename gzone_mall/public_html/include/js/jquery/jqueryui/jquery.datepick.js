...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			prevText: '&lt;이전', // Text for the previous month command
			prevStatus: '지난달 표시', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: '지난 년도 표시', // Status text for the previous year command
			nextText: '다음&gt;', // Text for the next month command
			nextStatus: '다음달 표시', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: '내년보기', // Status text for the next year command
			currentText: '현재', // Text for the current month command
			currentStatus: '현재달보기', // Status text for the current month command
			todayText: '오늘', // Text for the today's month command
			todayStatus: '오늘의 달 표시', // Status text for the today's month command
			clearText: '비우기', // Text for the clear command
			clearStatus: '전체 비우기', // Status text for the clear command
			closeText: '닫기', // Text for the close command
			closeStatus: '닫기', // Status text for the close command
			yearStatus: '년도변경', // Status text for year selection
			monthStatus: '년도변경', // Status text for month selection
	...
	_generateDayHeaders: function(inst, renderer) {
		...
		for (var day = 0; day < 7; day++) {
			...
			header += this._prepare(renderer.dayHeader, inst).replace(/\{day\}/g,
				...
				dayNames[dow] + '" style="font-size:11px;" >' + dayNamesMin[dow] + '</span>');
		}
		return header;
	},
