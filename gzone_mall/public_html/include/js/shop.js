// 목록에서 구매/장바구니 담기
function app_submit_from_list(pcode,_type,is_option,view_type) {
	view_type==''?'list':view_type;
	if(is_option) {
		//alert("옵션이 있는 상품입니다. 옵션을 선택해주시기 바랍니다.");
		if(confirm("옵션이 있는 상품은 옵션 선택 후 구매가능합니다.\n\n옵션을 선택하기 위해 상품 페이지로 이동하시겠습니까?")){
		...
		common_frame_tmp.location.href = '/program/shop.cart.pro.php?mode=add&pcode='+pcode+'&pass_type=' + _type + '&option_select_type=nooption&pass_mode=list&pass_view_type='+view_type;
