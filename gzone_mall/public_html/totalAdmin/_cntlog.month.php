...
<div class="group_title type_search">
	<strong><?=date("Y" , strtotime($pass_sdate))?>년</strong>
	<!-- 기간검색 -->
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="simple_search">
		...
		<div class="lineup-row type_date">
			<input type="text" name="pass_sdate" class='design js_pic_year_max_today right' value="<?=$pass_sdate?>" readonly style="width:60px;" autocomplete="off" placeholder="날짜 선택">
