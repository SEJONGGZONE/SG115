		...
		<table class="table_form">
			...
			<tbody>
				<tr>
					<th>구분</th>
					<td>
						<?php echo _InputRadio('_adchk', array('Y', 'N'), ($r['md_adchk']?$r['md_adchk']:'Y'), '', array('광고/이벤트', '일반'), ''); ?>
					</td>
				</tr>
				<tr>
					<th>메일링 제목</th>
					<td>
						<input type="text" name="_title" class="design" value="<?php echo $r['md_title']; ?>" style="width:400px" placeholder="메일링 제목">
						<?php echo _DescStr('광고, 이벤트성 메일을 발송 시 메일제목 앞에 "<strong>(광고)</strong>" 문구를 반드시 추가해야합니다. ', 'black'); ?>
					</td>
				</tr>
				<tr>
					<th>메일링 내용</th>
				...
				<tr>
					<th>등록시간</th>
					<td>
						<?php echo date('Y.m.d (H:i:s)', strtotime($r['md_rdate'])); ?>
					</td>
				</tr>
				<?php } ?>
			</tbody>
