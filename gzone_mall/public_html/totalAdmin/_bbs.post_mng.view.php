...
<form name="frmBbs" id="frmBbs" action="_bbs.post_mng.pro.php" method="post" enctype="multipart/form-data" autocomplete="off">
	...
	<div class="data_form">
		<table class="table_form">
			...
			<tbody>
				<tr>
					<th>제목</th>
					<td colspan="3"><div class="lineup-row"><?php echo $printTitle; ?></div></td>
				</tr>
				<tr>
					<th>작성자</th>
	...
	<?php if( $replyMode === true && count($rowReply)>0) { // 답변이 본문에 노출되는 게시판일경우  ?>
	<div class="group_title"><strong><?php echo '게시글 답변'?></strong></div>
	<div class="data_form">
		<table class="table_form">
			<colgroup>
				<col width="180"><col width="*"><col width="180"><col width="*">
	...
	<?php if( $r['bi_comment_use'] == 'Y'){ // 댓글이 사용중일 시 에만  ?>
		<div class="group_title"><strong>댓글</strong></div>
		<div class="reply_form">
			<textarea id="add-comment-content" rows="3" cols="" class="design" style="resize:none;" placeholder="댓글을 등록해주세요"></textarea>
			<a href="#none" class="c_btn h46 blue add-comment-submit">등록</a>
		</div>
