...
<div class="popup none_layer" >
	...
	<form name="frm" method="post" action="" enctype="multipart/form-data" class="form_wrap">
		<div class="pop_conts">
						...
						<tr>
							...
							<td>
								<div class="lineup-row type_multi">
									...
									<a href="_product_ticket.upload_sample.php" class="c_btn h27 green">샘플파일 다운</a>
								</div>
							</td>
						</tr>
			...
			<?php //옵션 프로그래스바 생성 - 상품 등록 끝난 후 적용 ?>
...
<script>
	...
	function progress(uid) {
		if(uid){
			...
			$.ajax({
				...
				url: '/totalAdmin/_product_ticket.pro.php',
	...
	$("#upload_submit").click(function(){
		...
		if(confirm("상품 또는 옵션 형태에 따라 시간이 걸리 수 있습니다. \n\n정말 업로드하시겠습니까?")){
			...
			$("form[name=frm]").attr({"action":"_product_ticket.upload.pro.php" , "target":"common_frame" });
			document.frm.submit();
			return true;
		}
	});
