...
<div class="tip_box">
	...
	<div class="c_tip"><em>권한없음</em> : [운영자별 메뉴관리]메뉴에서 관리자별 노출여부가 비노출로 설정된 메뉴입니다.</div>
	...
	<div class="c_tip"><em>연결페이지 없음</em> : [Admin 메뉴관리]메뉴 설정중 "파일명"설정이 되지 않아 연결할 페이지가 없는 메뉴 입니다.</div>
</div>