...
?>
	...
	<!-- ● 폼 영역 (검색/폼 공통으로 사용) -->
	<div class="data_search type_alwayopen">
		 <div class="group_title">
			<strong>운영자를 먼저 선택해주세요.</strong>
			<div class="btn_box">
			...
			<table class="table_form">
				...
				<tbody>
					<tr>
						...
						<td>
							<div class="tip_box">
								<div class="c_tip">상위메뉴가 숨김인 경우 하위 메뉴도 자동 숨김처리 되며, 상위메뉴가 노출일 경우 하위 메뉴를 개별적으로 설정할 수 있습니다. </div>
								<div class="c_tip">메뉴가 노출되기 위해서는 반드시 마지막 3차 메뉴가 노출로 설정되어야 합니다.</div>
							</div>
						</td>
					</tr>
				</tbody>
	...
	<div class="admin-menu-list-wrap">
		...
		<div class="data_list">
			...
			<div class="list_ctrl">
				<div class="left_box">
					<a href="#none" onclick="selectAll('Y'); return false;" class="c_btn gary line h27">전체선택</a>
					<a href="#none" onclick="selectAll('N'); return false;" class="c_btn gary line h27">선택해제</a>
					<a href="#none" onclick="selectAdminMenuSet('Y'); return false;" class="c_btn h27 blue">선택노출</a>
					<a href="#none" onclick="selectAdminMenuSet('N'); return false;" class="c_btn h27 black">선택숨김</a>
				</div>
			</div>
		...
		<div class="c_btnbox admin-menu-btn-box type_full" style="display: none;">
			<ul>
