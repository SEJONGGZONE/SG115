<?PHP
	...
	// 달력옵션 정보 입력 -- {
		$_dateoption_use = $_dateoption_use == 'Y' ? 'Y':'N';
		$set_dateoption_ex_week ='';
		if( is_array($_dateoption_ex_week) && count($_dateoption_ex_week) > 0 ){ $set_dateoption_ex_week = implode(",",$_dateoption_ex_week); }
	// 달력옵션 정보 입력 -- } 
		...
		$sque = "
			...
			, p_com_juso = '".addslashes($_com_juso)."'
			, p_com_mapx = '".$_com_mapx."'
			, p_com_mapy = '".$_com_mapy."'
			, p_com_locname = '".$_com_locname."'
			, p_com_tel = '".$_com_tel."'
			, p_com_time = '".$_com_time."'
			, p_expire_type = '".($_expire_type == '' ? 'limit':$_expire_type)."'
			, p_expire_day = '".rm_str($_expire_day)."'
			, p_expire_date = '".$_expire_date."'
			, p_dateoption_use = '".$_dateoption_use."'
			, p_dateoption_date_type = '".$_dateoption_date_type."'
			, p_dateoption_sday = '".$_dateoption_sday."'
			, p_dateoption_eday = '".$_dateoption_eday."'
			, p_dateoption_sdate = '".$_dateoption_sdate."'
			, p_dateoption_edate = '".$_dateoption_edate."'
			, p_dateoption_stime = '".$_dateoption_stime."'
			, p_dateoption_etime = '".$_dateoption_etime."'
			, p_dateoption_ex_week = '".$set_dateoption_ex_week."'
			, p_dateoption_ex_date = '".$_dateoption_ex_date."'			
	...
	switch( $_mode ){
		...
		case "add":
			...
			error_loc("_product_ticket.form.php?_mode=modify&_code=${_code}&_PVSC=${_PVSC}");
			break;
		...
		case "modify":
			...
			error_loc("_product_ticket.form.php?_mode=${_mode}&_code=${_code}&_PVSC=${_PVSC}");
			break;
		...
		case "delete":
			...
			error_loc("_product_ticket.list.php".($_PVSC ? '?'.enc('d' , $_PVSC) : null));
			break;
