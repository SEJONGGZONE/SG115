...
<div class="popup none_layer" >
	...
	<div class="pop_title">
		<strong>에디터 이미지 관리</strong>
		<a href="#none" class="btn_close" onclick="window.close();"></a>
	</div>

	<form name="frm_editimginfo" method="post" enctype="multipart/form-data"  target= "common_frame" class="pop_conts">
		...
		<div class="data_list">
			<table class="table_list type_nocheck">
				<colgroup>
					<col width="80"><col width="120"><col width="*"><col width="110"><col width="80">
				</colgroup>
				<thead>
					<tr>
						<th scope="col">NO</th>
							...
							<tr>
								...
								<td>
									<div class="lineup-row type_multi">
										...
										<a href="#none" onclick="upload(<?php echo $v['eiu_uid']; ?>);return false;" class="c_btn h27 dark img_modify">업로드</a>
									</div>
									<div class="lineup-row  wrap_img_btn_all" data-uid="<?php echo $v['eiu_uid']; ?>" data-url="<?php echo $edit_url_link;?>">
										...
										<span class="bar"></span>
										<a href="_config.editor_img.download.php?uid=<?php echo $v['eif_uid']; ?>" class="c_btn h27 dark line" target="common_frame">다운로드</a>	<?php // 이미지 개별 다운로드 ?>
										<a href="_config.editor_img.list.php" target="_blank" class="c_btn green line h27 ">파일관리</a> <?php // 이미지 파일 삭제 시 체크?>
									</div>
								</td>
								<?php // 에디터 이미지 변경일 ?>
								...
								<td class="this_ctrl">
									<a href="#none" onclick="del('_config.editor_img.pop.pro.php?_mode=delete&_edit_uid=<?php echo $v['eiu_uid']; ?>&_uid=<?php echo $_uid; ?>&_tn=<?php echo $tn;?>'); return false;" class="c_btn dark line h27 gray">삭제</a>
		...
		<div class="tip_box">
			<div class="c_tip">이미지 수정 시 동일 확장자로만 등록이 가능하며, 다른 페이지에서도 사용중인 경우 함께 수정됩니다.</div>
			<div class="c_tip">이미지를 삭제하더라도 파일 자체는 삭제되지 않으니 사용된 페이지의 에디터에서 직접 변경, 혹은 삭제해야 합니다.</strong></div>
			<div class="c_tip">파일삭제를 원하실 경우 ( 환경설정 > 운영 관리 설정 > 에디터 등록 이미지 관리 ) 부분에서 해당 파일을 삭제하실 수 있습니다.</div>
		<div>
