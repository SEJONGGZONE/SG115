...
<div class="popup none_layer">
				...
				<div class="data-box" data-pass-mode="<?php echo $pass_mode; ?>" data-pass-code="<?php echo $pass_code; ?>"></div> <?php // -- 다른 변수와 겹칠 수 있으니 별도 레이아웃으로 처리 ?>
					...
					<div class="list_ctrl">
						<div class="left_box">
							...
							<a href="#none" onclick="selectApply(); return false;" class="c_btn blue">선택 적용</a>
						</div>
						<div class="right_box">
				...
				<table class="table_list">
					...
					<?php
						...
						foreach($res as $k=>$v) {
							...
							$printBtn = '
								<a href="#none"  class="c_btn blue line get-apply" data-option-type="'.$v['cos_type'].'" data-option-depth="'.$v['cos_depth'].'" data-uid="'.$v['cos_uid'].'" data-option1-type="'.$v['cos_option1_type'].'" data-option2-type = "'.$v['cos_option2_type'].'" data-option3-type ="'.$v['cos_option3_type'].'">적용</a>
							'; // 관리버튼
							...
							// -- 출력
							echo '<tr>';
							echo '	<td class="this_check">
											<label class="design">
												<input type="checkbox" class="js_ck cos-uid" name="arrUid[]" value="'.$v['cos_uid'].'" data-option-type="'.$v['cos_type'].'" data-option-depth="'.$v['cos_depth'].'" data-option1-type="'.$v['cos_option1_type'].'" data-option2-type = "'.$v['cos_option2_type'].'" data-option3-type ="'.$v['cos_option3_type'].'" >
											</label>
										</td>';
	...
	<div class="c_btnbox type_full">
		<ul>
			<li><a href="#none" onclick="selectApply(); return false;" class="c_btn blue">선택 적용</a></li>
