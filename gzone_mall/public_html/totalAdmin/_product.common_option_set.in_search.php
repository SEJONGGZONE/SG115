	...
	<?php }} ?>
        ...
        <div class="group_title">
            <strong>Search</strong><!-- 메뉴얼로 링크 --><?=openMenualLink('자주쓰는 옵션 관리')?>
            <div class="btn_box">
                ...
                <?php } ?>
                <a href="_product.common_option_set.form.php<?php echo URI_Rebuild('?', array('_mode'=>'add', '_PVSC'=>$_PVSC)); ?>" class="c_btn h46 red" accesskey="a">옵션등록</a>
            </div>
        </div>
			...
			<table class="table_form">
				...
				<tbody>
					<tr>
						...
						<td>
                            <div class="lineup-row type_multi">
                                <select name="pass_input_type">
                                    ...
                                    <option value="title" <?=$pass_input_type == 'title' ? 'selected' : ''?>>옵션 관리명</option>
						...
						<th>구분</th>
						<td>
							<?php echo _InputRadio( 'pass_option_type' , array('', 'option', 'addoption'), ($pass_option_type) , '' , array('전체', '필수옵션', '추가옵션') , ''); ?>
						</td>
					</tr>
					<tr>
						<th>옵션차수</th>
						<td colspan="3">
							<?php echo _InputRadio( 'pass_option_depth' , array('', '1', '2','3'), ($pass_option_depth) , '' , array('전체', '1차 옵션', '2차 옵션','3차 옵션') , ''); ?>
						</td>
					</tr>
				</tbody>
			</table>
