...
?>
		...
		<div class="mobile_tip">자주쓰는 메뉴는 PC에서만 오른쪽 상단에 노출됩니다.</div>
		<div class="category">
			<ul class="table">
				<li class="td">
					<div class="depth_tt"><strong>메뉴분류</strong><a href="#none" onclick="viewFavMenuForm('add','1',''); return false;" class="c_btn h23 blue scrollto" data-scrollto="view-form">추가</a></div>
				...
				<li class="td">
					<div class="depth_tt"><strong>세부메뉴</strong><a href="#none" onclick="viewFavMenuForm('add','2',''); return false;" style="<?=$locUid1 == '' ? 'display:none;':''?>" class="c_btn h23 blue scrollto add-favmenu" data-scrollto="view-form" data-depth="2">추가</a></div>
