		...
		case "list":
			...
			if(sizeof($r) > 0){
				...
				foreach( $r as $k=>$v ){
					...
					echo "
						<li>
							<div class='category_name'><strong>". implode("</strong><em>&gt;</em><strong>" , array_values(array_filter($arr_parent))) ."</strong></div>
							<a href='#none' onclick=\"category_delete('". $v['pct_cuid'] ."');\" class='c_btn h22 black line'>삭제</a>
						</li>
					";
				}
				echo "
