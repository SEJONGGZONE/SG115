<?php include_once('wrap.header.php');?>
		...
		<div class="category">
			<ul class="table">
				<li class="td">
					<div class="depth_tt"><strong>1차 메뉴</strong><a href="#none" onclick="viewAdminMenuForm('add','1',''); return false;" class="c_btn h23 blue scrollto" data-scrollto="view-form">추가</a></div>
				...
				<li class="td">
					<div class="depth_tt"><strong>2차 메뉴</strong><a href="#none" onclick="viewAdminMenuForm('add','2',''); return false;" style="<?=$locUid1 == '' ? 'display:none;':''?>" class="c_btn h23 blue scrollto add-admin-menu" data-scrollto="view-form" data-depth="2">추가</a></div>
				...
				<li class="td">
					<div class="depth_tt"><strong>3차 메뉴</strong><a href="#none" onclick="viewAdminMenuForm('add','3',''); return false;" style="<?=$locUid2 == '' ? 'display:none;':''?>" class="c_btn h23 blue scrollto add-admin-menu" data-scrollto="view-form" data-depth="3">추가</a></div>
