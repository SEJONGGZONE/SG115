	...
	switch($ajaxMode){
		...
		case "adminMenuList":
			...
			foreach($resAdminMenu as $k=>$v){
					...
					else{ $btnView = '<span class="c_tag light h18">숨김</span>';  }

					$printAdminMenuList .= '<tr class="amdin-menu-list" data-depth="1" data-uid="'.$v['am_uid'].'">';
					$printAdminMenuList .= '	<td class="this_check"><label class="design"><input type="checkbox" name="adminMenu[]" value="'.$v['am_uid'].'" class="js_ck"></label></td>';
					$printAdminMenuList .= '	<td class="this_state">'.$btnView.'</td>';
					$printAdminMenuList .= '	<td class="t_left">'.$v['am_name'].'</td>';
					$printAdminMenuList .= '	<td class="this_ctrl">';
					$printAdminMenuList .= '		<div class="lineup-row type_center">';
					...
					$printAdminMenuList .= '			<a href="#none" onclick="return false;" class="c_btn h28 dark btn-admin-view-single" data-depth="1" data-uid="'.$v['am_uid'].'">바로적용</a>';
					...
					foreach($resAdminMenuDepth2 as $k2=>$v2){
							...
							$btnView = '';
							if($v2['ams_uid'] != ''){ $btnView = '<span class="c_tag blue line h18 ">노출</span>';  }
							else{ $btnView = '<span class="c_tag h18 light">숨김</span>';  }

							// -- 하단메뉴 :: 상위메뉴 처리
							$disabledChk = $v['ams_uid'] == '' ? ' disabled = "disabled" ':'';

							$printAdminMenuList .= '<tr class="amdin-menu-list" data-depth="2" data-uid="'.$v2['am_uid'].'">';
							$printAdminMenuList .= '	<td class="this_check"><label class="design"><input type="checkbox" name="adminMenu[]" value="'.$v2['am_uid'].'" class="js_ck"></label></td>';
							$printAdminMenuList .= '	<td class="this_state">'.$btnView.'</td>';
							...
							$printAdminMenuList .= '			</select>';
							$printAdminMenuList .= '			<a href="#none" onclick="return false;" class="c_btn h28 dark btn-admin-view-single" data-depth="2"  data-uid="'.$v2['am_uid'].'">바로적용</a>';
							$printAdminMenuList .= '		</div>';
							$printAdminMenuList .= '	</td>';
							$printAdminMenuList .= '</tr>';
						...
						foreach($resAdminMenuDepth3 as $k3=>$v3){
								...
								$btnView = '';
								if($v3['ams_uid'] != ''){ $btnView = '<span class="c_tag blue line h18 ">노출</span>';  }
								else{ $btnView = '<span class="c_tag h18 light">숨김</span>';  }
								...
								$printAdminMenuList .= '	<td class="this_check"><label class="design"><input type="checkbox" name="adminMenu[]" value="'.$v3['am_uid'].'" class="js_ck"></label></td>';
								$printAdminMenuList .= '	<td class="this_state">'.$btnView.'</td>';
								...
								$printAdminMenuList .= '			</select>';
								$printAdminMenuList .= '			<a href="#none" onclick="return false;" class="c_btn h28 dark btn-admin-view-single" data-depth="3"  data-uid="'.$v3['am_uid'].'">바로적용</a>';
								$printAdminMenuList .= '		</div>';
								$printAdminMenuList .= '	</td>';
								$printAdminMenuList .= '</tr>';
						}
