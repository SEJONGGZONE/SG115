...
<div class="data_graph_wrap">
		...
		<ul>
			<li>
				<?php if(count($mem_date)>0){?>
					<canvas id="js_couter_chart2" height="330"></canvas><!-- 회원구분 -->
				<?php }else{?>
	...
	<div class="data_graph">
		...
		<ul>
			<li>
				<?php if(count($mem_date)>0){?>
					<canvas id="js_couter_chart3" height="330"></canvas><!-- 수신여부 -->
				<?php }else{?>
					<div class="common_none"><div class="no_icon"></div><div class="gtxt">아직 데이터가 없습니다.</div></div>
				<?php }?>
			</li>
...
<?=_DescStr("일반(사이트에서 직접가입)과 SNS가입(페이스북, 카카오, 네이버)은 중복이 가능하여, 합계가 회원수와 상이할 수 있습니다.",'red')?>
...
<script type="text/javascript" class="code-js">
    ...
    var grid = new tui.Grid({
        ...
        columnModelList: [
            {"title" : "<b>날짜</b>", "columnName" : "rdate", "align" : "center", "width" : 100 },
