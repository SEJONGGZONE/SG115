...
<div class="popup none_layer" >
	...
	<form name="bannerProductForm" class="form_wrap">
					...
					<tbody>
						...
						?>
							<tr>
								<td class="this_check">
									<label class="design">
										<input type="radio" name="app_pcode" class="js_ck chk_box js_pcode" value="<?php echo $v['p_code']; ?>"<?php echo ($save_code == $v['p_code']?' checked':null); ?>>
									</label>
								</td>
		...
		<div class="c_btnbox type_full">
			<ul>
				<li><span class="c_btn h34 blue"><input type="button" value="선택상품 추가" onclick="bannerProductAdd();"  /></span></li>
