...
<div class="data_list">
	...
	<div class="tip_box">
		<?=_DescStr("판매된 상품에 다수의 카테고리가 지정될 경우, 지정된 모든 카테고리에 합산되며 <strong>카테고리별 수치와 요약 수치가 다를 수 있습니다.</strong>");?>
...
<script type="text/javascript" class="code-js">
    ...
    var grid = new tui.Grid({
        ...
        columnModelList: [
            {"title" : "<b>순위</b>", "columnName" : "idx", "align" : "center", "width" : 10 },
			{"title" : "<b>카테고리</b>", "columnName" : "category", "align" : "left", "width" : 120},
