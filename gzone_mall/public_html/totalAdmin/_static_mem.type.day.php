	...
	<table class="table_must">
		...
		<tbody>
			<tr>
				...
				<td class="t_blue t_bold t_right"><?php echo number_format( IS_ARRAY($arr_data['sleep']) ? array_sum($arr_data['sleep']) : 0) ?>명</td>
				<td class="t_blue t_bold t_right"><?php echo number_format( IS_ARRAY($arr_data['out']) ? array_sum($arr_data['out']) : 0) ?>명</td>
			</tr>
		</tfoot>
	</table>
</div>
