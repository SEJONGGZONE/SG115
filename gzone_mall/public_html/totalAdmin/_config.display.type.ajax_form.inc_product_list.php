...
<div class="list_ctrl ">
	<div class="left_box">
		...
		<a href="#none" onclick="return false;" class="c_btn h27 black line select-type-product-delete">선택삭제</a>
	</div>
	<div class="right">
		<a href="#none" onclick="selectTypeProductAddpop(); return false;" class="c_btn h27 blue">상품추가</a>
	</div>
</div>
	...
	<table class="table_list">
		...
		?>
				<tr>
					<td class="this_check"><label class="design"><input type="checkbox" class="js_ck type-pcode" value="<?php echo $v['p_code'];?>" name="chk_pcode[]"></label></td>
					<td class="this_num"><?php echo $_num;?></td>
					<td class="this_ctrl">
						<div class="lineup-updown_ctrl">
							<div class="ctrl_form">
								<input type="text" name="sort_group[<?php echo $v['p_code'];?>]" value="<?php echo $v['dtp_sort_group'];?>" class="design number_style sort_group_<?php echo $v['p_code'];?>" placeholder="0">
...
<?php }else{?>
	<div class="common_none">
		...
		<a href="#none" onclick="selectTypeProductAddpop(); return false;" class="c_btn h27 blue">타입별 상품 추가하기</a>
	</div>
<?php }?>
