...
<div class="group_title type_search">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="simple_search">
        ...
        <div class="lineup-row type_date">
            <input type="text" name="pass_date" class="design js_pic_year_max_today right" value="<?php echo $pass_date; ?>" autocomplete="off" placeholder="날짜 선택" style="width:70px" readonly>
