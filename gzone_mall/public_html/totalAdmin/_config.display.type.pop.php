...
<div class="popup none_layer" >
	...
	<?php
		...
		$search_detail_name = 'display_type';
	...
	<form name="typeProductForm" class="form_wrap">
			...
			<div class="data_list">
				<div class="list_ctrl">
					<div class="left_box">
						...
						<span class="c_btn h27 blue"><input type="button" name="" value="선택 상품추가"  onclick="typeProductAdd();"/></span>
					</div>
					<div class="right_box">
		...
		<div class="c_btnbox type_full">
			<ul>
				<li><span class="c_btn h34 blue"><input type="button" value="선택상품 추가" onclick="typeProductAdd();"  /></span></li>
		...
		<div class="fixed_save js_fixed_save" style="display:none;">
			<div class="wrapping">
				<div class="c_btnbox type_full">
					<ul>
						<li><span class="c_btn h34 black"><input type="button" value="선택상품 추가" onclick="typeProductAdd();" /></span></li>
						<li><a href="#none" onclick="window.close(); return false;" class="c_btn h34 black line normal" accesskey="x">창닫기</a></li>
					</ul>
				</div>
			</div>
