...
<div class="data_list">
	<table class="table_list">
		<colgroup>
			...
			<col width="100"><col width="60"><col width="80">
		</colgroup>
		<thead>
			<tr>
				<th scope="col">이미지</th>
		...
		<tbody>
			...
			?>
					<tr>
							...
							<div class="order_item">
								...
								?>
									<div class="option bullet">
										<span class="option_name"><?php echo ($v['op_is_addoption'] == 'Y'?'추가 : ':'선택 : '); ?><?php echo implode(" / ",$arr_option_name); ?></span>
									</div>
								<?php } ?>
							</div>
						</td>
						...
						<td>
							<div class="lineup-vertical">
								<a href="_order.form.php<?php echo URI_Rebuild('?', array('_mode'=>'modify','view'=>'order4_view', '_ordernum'=>$v['op_oordernum'])); ?>" class="c_btn h22" target="_blank">상세보기</a>
							</div>
						</td>
					</tr>
				<?php } ?>
