<?php
// {LCY} : 하이앱
$_REQUEST['app'] = EMPTY($_REQUEST['app']) ? '': $_REQUEST['app'];
if($_REQUEST['app'] == 'on'){ 
	include_once "../addons/app/totalAdmin/_addons.php"; 
	return;
}
...
<div class="c_tab">
	...
	<?php foreach($arrAddonsService['tabMenu_'.$_menuType] as $k=>$v){ ?>
		<li class="<?php echo $k==$pass_menu ? "hit":""?>">
			<a href="_addons.php?_menuType=<?php echo $_menuType?>&pass_menu=<?php echo $k;?>" class="btn"><strong><?php echo $v?></strong></a>
		</li>
	<?php } ?>
	</ul>
</div>
