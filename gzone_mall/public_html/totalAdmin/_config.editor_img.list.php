...
?>
			...
			<table class="table_form">
				<colgroup>
					...
					<tr>
						...
						<td>
							<div class="tip_box">
								<div class="c_tip">이미지 수정 시 동일 확장자로만 수정 가능하며 용량이 큰 이미지가 있을 경우 로딩 속도가 느려질 수 있습니다.</div>
								<div class="c_tip">이미지 파일 삭제 시 사용하는 모든 이미지가 삭제되니, 사용 개수를 꼭 확인해주세요.</div>
								<div class="c_tip">이미지는 하루한번 3일 이내 수정된 파일이 업데이트 되며, 현재를 기준으로 일주일동안 수정이 없을 시 사용여부 체크 후 사용하지 않으면 삭제됩니다.</div>
								<div class="c_tip">이미지 개별관리에서의 삭제가 아닌 상품, 게시판 등을 삭제 하였을 시 노출 페이지 수/파일은 변경되지 않으며 일주일 뒤 변경됩니다.</div>
							</div>
						</td>
					</tr>
				</tbody>
					...
					<tr>
						...
						<td>
                            <div class="lineup-row type_date">
                                ...
                                <input type="text" name="pass_edate" value="<?php echo $pass_edate; ?>" class="design js_pic_day" style="width:85px" autocomplete="off" placeholder="날짜 선택" readonly>
                            </div>
						</td>
						<th>노출여부</th>
						<td>
	...
	<div class="data_list">
		...
		<input type="hidden" name="_uid" value="">
			...
			<div class="list_ctrl">
				<div class="left_box">
					<a href="#none" onclick="selectAll('Y'); return false;" class="c_btn gray line h27">전체선택</a>
					<a href="#none" onclick="selectAll('N'); return false;" class="c_btn gray line h27">선택해제</a>
					<a href="#none" onclick="selectDelete(); return false;" class="c_btn h27 dark line">선택삭제</a>
				</div>
				<div class="right_box">
			...
			<table class="table_list">
				<colgroup>
					<col width="40"/><col width="70"/><col width="100"/><col width="90"/><col width="*"/><col width="90"/><col width="110"/><col width="80"/>
				</colgroup>
				<thead>
					<tr>
				...
				<tbody>
					...
					?>
								...
								<td class="this_check"><label class="design"><input type="checkbox" class="js_ck" name="editimg_chk[<?php echo $v['eif_uid']; ?>]"></td>
								<td class="this_num"><?php echo $_num; ?></td><?php //NO ?>
								<td class="this_state">
									<?php echo $arr_adm_button[($v['eif_use_cnt'] > 0 ? '노출' : '숨김')]; ?>
								</td>
								...
								<td>
									<div class="lineup-row type_multi">
										...
										<a href="#none" onclick="upload(<?php echo $v['eif_uid']; ?>);return false;" class="c_btn h27 dark img_modify">업로드</a><!-- 에디터 이미지 파일수정 버튼 -->
									</div>
									<div class="lineup-row wrap_img_btn_all" data-uid="<?php echo $v['eif_uid']; ?>" data-url="<?php echo $edit_url_link; ?>">
										<a href="#none" onclick="img_btn_all('preview' , <?php echo $v['eif_uid']; ?>)" class="c_btn h22 gray" >미리보기</a>
										<a href="#none" onclick="img_btn_all('tag_copy' , <?php echo $v['eif_uid']; ?>)"  class="c_btn h22 gray line tag_btn" >소스복사</a>
										<a href="#none" onclick="img_btn_all('url_copy' , <?php echo $v['eif_uid']; ?>)" class="c_btn h22 gray line url_btn" >URL복사</a>
										<?php if($v['eif_use_cnt'] >= 1 && $edit_img_link){  //이미지 개별 다운로드?>
											<div class="bar"></div>
											<a href="_config.editor_img.download.php?uid=<?php echo $v['eif_uid']; ?>"  class="c_btn h27 dark line" target="common_frame">다운로드</a>
											<a href="#none" class="c_btn h27 green line file_btn" data-uid="<?php echo $v['eif_uid']; ?>">사용목록</a><!-- 에디터 이미지 사용처 노출 -->
										<?php }?>
									</div>
								</td>
								<td><span class="hidden_tx">노출 페이지</span><?php echo $v['eif_use_cnt']; ?>개</td><?php // 이미지 노출 페이지 수 ?>
								<td class="this_date date_time">
									<div class="t_red">
									...
									<?php echo printDateInfo($v['eif_rdate']);?>
								</td>
								<td class="this_ctrl">
									<div class="lineup-row type_center wrap_img_btn_all" data-uid="<?php echo $v['eif_uid']; ?>" data-url="<?php echo $edit_url_link; ?>">
										<a href="#none" onclick="del('_config.editor_img.pro.php?_mode=delete&_uid=<?php echo $v['eif_uid']; ?>&_PVSC=<?php echo $_PVSC; ?>'); return false;" class="c_btn h27 dark line">삭제</a><!-- 에디터 이미지 삭제 버튼 -->
									</div>
								</td>
							</tr>
					<?php
	...
	<div class="popup _img_preview" style="display:none;" >
		...
		<div class="pop_conts">
			<div class="data_form tab_conts" data-idx="preview">
				<img id="preview_img" src="" class="design" data-idx="'preview_img'">
			</div>
			<div class="data_form tab_conts" data-idx="tag_copy">
				<table class="table_form">
					<tbody>
						<tr>
							<th>상대경로</th>
							<td>
								<div class="lineup-row type_multi">
									<input type="text"  id="tag_img"  data-idx="tag_img" class="design" readonly>
									<a href="#none"  data-clipboard-target="#tag_img" class="c_btn gray line h28 js-clipboard" onclick="return false;">복사</a>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="lineup-row type_multi">
									<input type="text"  id="tag_img_full"  data-idx="tag_img_full" class="design" readonly>
									<a href="#none"  data-clipboard-target="#tag_img_full" class="c_btn h28 gray line js-clipboard" onclick="return false;">복사</a>
								</div>
							</td>
						</tr>
					</tbody>
			...
			<div class="data_form tab_conts" data-idx="url_copy">
				<table class="table_form">
					<tbody>
						<tr>
							<th>상대경로</th>
							<td>
								<div class="lineup-row type_multi">
									<input type="text"  id="url_img"  data-idx="url_img" class="design" readonly>
									<a href="#none"  data-clipboard-target="#url_img" class="c_btn h28 gray line js-clipboard" onclick="return false;">복사</a>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="lineup-row type_multi">
									<input type="text"  id="url_img_full"  data-idx="url_img_full" class="design" readonly>
									<a href="#none"  data-clipboard-target="#url_img_full" class="c_btn gray line h28 js-clipboard" onclick="return false;">복사</a>
								</div>
							</td>
						</tr>
					</tbody>
	...
	<!-- 에디터 사용관리 레이어팝업 -->
	<div class="popup _img_file edit_img_layerpop" style="display:none;" >
