...
<div class="group_title type_search">
	<strong><?=date("Y" , strtotime($pass_sdate))?>년 <?=date("m" , strtotime($pass_sdate))?>월</strong>
	<!-- 기간검색 -->
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="simple_search">
		...
		<div class="lineup-row type_date simple_form">
			<input type="text" name="pass_sdate" class="design js_pic_month_max_today right" value="<?php echo $pass_sdate; ?>" style="width:70px" autocomplete="off" placeholder="날짜 선택" readonly>
...
<div class="data_graph">
	<ul>
		<li><canvas id="js_couter_chart1" height="330"></canvas><!-- 접속기기별 --></li>
	</ul>
</div>


<div class="group_title type_first"><strong>회원구분</strong></div>
<div class="data_graph">
	<ul>
		<li><canvas id="js_couter_chart2" height="330"></canvas><!-- 회원구분별 --></li>
	</ul>
</div>
...
<script type="text/javascript" class="code-js">
    ...
    var grid = new tui.Grid({
        ...
        columnModelList: [
            {"title" : "<b>날짜</b>", "columnName" : "rdate", "align" : "center", "width" : 110 },
