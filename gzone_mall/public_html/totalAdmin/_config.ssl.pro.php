<?PHP
	...
	switch($pass_menu){
		...
		case "_config.ssl.default_form":
			...
			if(str_replace(array('https://', 'http://'), '', $arr['ssl_domain']) <> '') $ssl_condition = CurlExecHeader($arr['ssl_domain'].'/program/_ping.php',100,true); // 200 이 아니면 비정상 // # 2019-04-16 SSJ :: 도메인이 입력 체크 추가
