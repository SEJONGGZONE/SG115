...
<div class="popup none_layer">
	...
	<?php
		...
		$search_detail_name = 'display_main';
	...
	<form name="mainProductForm" class="form_wrap">
			...
			<div class="data_list">
				...
				<div class="list_ctrl">
					<div class="left_box">
						...
						<span class="c_btn h27 blue"><input type="submit" name="" value="선택상품 추가" onclick="mainProductAdd();"/></span>
					</div>
		...
		<div class="c_btnbox type_full">
			<ul>
				<li><span class="c_btn h34 blue"><input type="button" name="" value="선택상품 추가" onclick="mainProductAdd();"  /></span></li>
