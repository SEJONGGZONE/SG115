...
<div class="mobile_tip">스크롤을 양쪽으로 이동해서 확인해주세요.</div>
<div class="mobile_tip">충전 및 결제는 PC에서만 가능하니 확인 후 PC에서 진행해주세요.</div>

<div class="iframe_out mobitalk_charge">
	<iframe name="pass_mobitalk" src="<?=$url?>&cross_url=<?php echo urlencode($system['url']); ?>" scrolling="no"  frameborder=0 class="js_auto_height" ID="wrap_iframe_mobitalk"></iframe>
</div>
