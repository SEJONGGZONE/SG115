		...
		<div class="grid_section">
			<div class="layout_fix">
                <div class="c_board_ctrl">
                    ...
                    <form role="search" name="qnaSearch" action="/" method="get" class="area_box area_right">
                            ...
                            <ul class="js_view">
                                <li class="this_tit" data-uid="<?php echo $v['pt_uid']; ?>" data-hit="false">
                                    ...
                                    <div class="posting">
                                        ...
                                        <a href="<?php echo $pro_link; ?>" class="about_item" target="_blank">상품명 : <?php echo $v['p_name']; ?></a>
                                    </div>
                                </li>
                                <li class="this_info">
                                    <div class="writer"><?php echo LastCut2($v['pt_inid'], 3); ?></div>
                                ...
                                <li class="open_conts">
                                    ...
                                    <?php if(count($reply_r) > 0) { // 관리자답변있을때만 나옴 ?>
