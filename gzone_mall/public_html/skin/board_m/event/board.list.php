...
<div class="c_board_gallery type_event">
	<script>
		// -- 게시물 검색 :: 공통
				...
				<div class="post_box">
                    ...
                    <div class="posting">
                        <div class="info">
							...
							<span class="tag_state<?php echo $v['eventClose'] === true ?' type_end':''; ?>"><?php echo $v['eventDay'];?></span>
                        </div>
                        <div class="tit">
							<a href="<?php echo $v['postUrl']; ?>" class="upper_link<?php echo $v['secretEvtClass'];?>" data-uid="<?php echo $v['uid'] ?>" data-mode="view" title=""></a>
